var gh = (function() {
    ...
    return {
      getToken: function(interactive, callback) {
        ...
        function exchangeCodeForToken(code) {
          ...
          xhr.open('POST','https://bitbucket.org/site/oauth2/access_token' , true);
         ...
         // xhr.setRequestHeader('Accept', 'application/json');
          xhr.onload = function () {
            ...
            //var formData = ("grant_type=authorization_code","client_id=JwM9bYKusyDVDbQ2qG","client_secret=Fjv7UDk3BPTzfP2eyM9qckHqQHnEtcPn");
            //console.log(formData);
            var formData = ('grant_type=authorization_code'+'&client_id='+clientId+'&client_secret='+clientSecret+'&code='+ code +'&redirect_uri=' + encodeURIComponent(redirectUri));
  ...
  function getUserInfo(interactive) {
    xhrWithAuth('GET',
                'https://api.bitbucket.org/2.0/repositories/treestonemedi/',
                interactive,
                onUserInfoFetched);
  }
